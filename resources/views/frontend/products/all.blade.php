                        ...
                        <div class="col-lg-9">
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-lg-6">
                                    <div class="de-item mb30">
                                        <div class="d-img">
                                            <img src="{{asset('/')}}images/cars/chevrolet-camaro.jpg" class="img-fluid" alt="">
                                        </div>
                                        <div class="d-info">
                                            <div class="d-text">
                                ...
                                <div class="col-xl-4 col-lg-6">
                                    <div class="de-item mb30">
                                        <div class="d-img">
                                            <img src="{{asset('/')}}images/cars/hyundai-staria.jpg" class="img-fluid" alt="">
                                        </div>
                                        <div class="d-info">
                                            <div class="d-text">
                                        ...
                                        <div class="d-atr-group">
                                                    ...
                                                    <span class="d-atr"><img src="{{asset('/')}}images/icons/2-green.svg" alt="">2</span>
                                                    <span class="d-atr"><img src="{{asset('/')}}images/icons/3-green.svg" alt="">4</span>
                                                    <span class="d-atr"><img src="{{asset('/')}}images/icons/4-green.svg" alt="">Minivan</span>
                                                </div>
                                                <div class="d-price">
                                ...
                                <div class="col-xl-4 col-lg-6">
                                    <div class="de-item mb30">
                                        <div class="d-img">
                                            <img src="{{asset('/')}}images/cars/toyota-rav.jpg" class="img-fluid" alt="">
                                        </div>
                                        <div class="d-info">
                                            <div class="d-text">
                                                <h4>Toyota Rav 4</h4>
                                ...
                                <div class="col-xl-4 col-lg-6">
                                    <div class="de-item mb30">
                                        <div class="d-img">
                                            <img src="{{asset('/')}}images/cars/bentley.jpg" class="img-fluid" alt="">
                                        </div>
                                        <div class="d-info">
                                            <div class="d-text">
                                                <h4>Bentley</h4>
                                ...
                                <div class="col-xl-4 col-lg-6">
                                    <div class="de-item mb30">
                                        <div class="d-img">
                                            <img src="{{asset('/')}}images/cars/lexus.jpg" class="img-fluid" alt="">
                                        </div>
                                        <div class="d-info">
                                            <div class="d-text">
                                                <h4>Lexus</h4>
                                ...
                                <div class="col-xl-4 col-lg-6">
                                    <div class="de-item mb30">
                                        <div class="d-img">
                                            <img src="{{asset('/')}}images/cars/range-rover.jpg" class="img-fluid" alt="">
                                        </div>
                                        <div class="d-info">
                                            <div class="d-text">
                                                <h4>Range Rover</h4>
